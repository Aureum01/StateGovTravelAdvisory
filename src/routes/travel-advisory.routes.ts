...
import { TravelAdvisoryController } from '../controllers/travel-advisory.controller';

const router = Router();
const controller = new TravelAdvisoryController();
...
router.get(
  ...
  controller.getTravelAdvisories.bind(controller)
);
...
router.get(
  ...
  controller.getTravelAdvisoryByCountry.bind(controller)
);
...
router.get(
  ...
  controller.getTravelAdvisoriesByLevel.bind(controller)
);
